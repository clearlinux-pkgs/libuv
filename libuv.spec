...
Version  : 1.33.1
Release  : 20
URL      : https://github.com/libuv/libuv/archive/v1.33.1/libuv-1.33.1.tar.gz
Source0  : https://github.com/libuv/libuv/archive/v1.33.1/libuv-1.33.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571666519
...
cp %{_builddir}/libuv-1.33.1/LICENSE %{buildroot}/usr/share/package-licenses/libuv/848f7398f89046426a7ba23cb56cd3c93c030c64
cp %{_builddir}/libuv-1.33.1/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
cp %{_builddir}/libuv-1.33.1/samples/socks5-proxy/LICENSE %{buildroot}/usr/share/package-licenses/libuv/baf66f4b03cb3662de800d5f5895314fbafbd6d2
%make_install
