...
Source0  : https://github.com/libuv/libuv/archive/v1.48.0/libuv-1.48.0.tar.gz
...
%prep
%setup -q -n libuv-1.48.0
cd %{_builddir}/libuv-1.48.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707405157
mkdir -p clr-build
pushd clr-build
