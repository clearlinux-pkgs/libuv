...
Version  : 1.44.0
Release  : 34
URL      : https://github.com/libuv/libuv/archive/v1.44.0/libuv-1.44.0.tar.gz
Source0  : https://github.com/libuv/libuv/archive/v1.44.0/libuv-1.44.0.tar.gz
...
%prep
%setup -q -n libuv-1.44.0
cd %{_builddir}/libuv-1.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646678457
...
cp %{_builddir}/libuv-1.44.0/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
%make_install
