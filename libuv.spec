...
Version  : 1.44.1
Release  : 35
URL      : https://github.com/libuv/libuv/archive/v1.44.1/libuv-1.44.1.tar.gz
Source0  : https://github.com/libuv/libuv/archive/v1.44.1/libuv-1.44.1.tar.gz
...
%prep
%setup -q -n libuv-1.44.1
cd %{_builddir}/libuv-1.44.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646869905
...
cp %{_builddir}/libuv-1.44.1/LICENSE %{buildroot}/usr/share/package-licenses/libuv/995532b42e0ad16d5ee90d1538f3d74a91fa76e6
cp %{_builddir}/libuv-1.44.1/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
%make_install
...
/usr/share/package-licenses/libuv/995532b42e0ad16d5ee90d1538f3d74a91fa76e6
