...
Version  : 1.40.0
Release  : 29
URL      : https://github.com/libuv/libuv/archive/v1.40.0/libuv-1.40.0.tar.gz
Source0  : https://github.com/libuv/libuv/archive/v1.40.0/libuv-1.40.0.tar.gz
...
%prep
%setup -q -n libuv-1.40.0
cd %{_builddir}/libuv-1.40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601051015
...
cp %{_builddir}/libuv-1.40.0/LICENSE %{buildroot}/usr/share/package-licenses/libuv/848f7398f89046426a7ba23cb56cd3c93c030c64
cp %{_builddir}/libuv-1.40.0/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
%make_install
