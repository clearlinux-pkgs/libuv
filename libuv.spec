...
Source0  : https://github.com/libuv/libuv/archive/v1.49.0/libuv-1.49.0.tar.gz
...
%prep
%setup -q -n libuv-1.49.0
cd %{_builddir}/libuv-1.49.0
pushd ..
cp -a libuv-1.49.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727268550
mkdir -p clr-build
pushd clr-build
