...
Source0  : https://github.com/libuv/libuv/archive/v1.44.2/libuv-1.44.2.tar.gz
...
%prep
%setup -q -n libuv-1.44.2
cd %{_builddir}/libuv-1.44.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657657561
...
cp %{_builddir}/libuv-1.44.2/LICENSE %{buildroot}/usr/share/package-licenses/libuv/995532b42e0ad16d5ee90d1538f3d74a91fa76e6
cp %{_builddir}/libuv-1.44.2/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
%make_install
