...
Version  : 1.38.1
Release  : 27
URL      : https://github.com/libuv/libuv/archive/v1.38.1/libuv-1.38.1.tar.gz
Source0  : https://github.com/libuv/libuv/archive/v1.38.1/libuv-1.38.1.tar.gz
...
%prep
%setup -q -n libuv-1.38.1
cd %{_builddir}/libuv-1.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594048616
...
cp %{_builddir}/libuv-1.38.1/LICENSE %{buildroot}/usr/share/package-licenses/libuv/848f7398f89046426a7ba23cb56cd3c93c030c64
cp %{_builddir}/libuv-1.38.1/LICENSE-docs %{buildroot}/usr/share/package-licenses/libuv/1167f0e28fe2db01e38e883aaf1e749fb09f9ceb
%make_install
